...
<div class="container">
        ...
        foreach($posts as $post){
            ...
            <header class="entry-header">
                        ...
                        <div class="entry-meta">
                            <ul>
                                <li class="grey-text"> <?php echo date('d-m-y',strtotime($post['date_posted'])); ?></li>

                                <li><a href="#" title="" rel="category tag"> <a href='category.php?id=<?php echo $post['category_id']; ?>' ><?php echo "<font color='green'>".$post['name']."</font>"; ?></a></li>
    ...
    ?>
    <p><a class="green-text" href="category.php?id=<?php echo $category['id'];?>"><?php echo $category['name']; ?></a>
        <?php
        }
        ?>
</div>
