...
<body>
   ...
   <div id="content-wrap container">
     ...
     <div>
         ...
         <input type="text" name='contents' <?php echo $post[0]['contents']; ?></input>
      </div>
     <div>
     ...
     <p><input class="btn btn-large green darken-2" type='submit' value='Add Post' /></p>
   		...
   		<div id="sidebar" class="four columns">
   			...
   			<div class="widget widget_categories group container">
   				<h3>Categories</h3>
   				<?php
     foreach(get_categories() as $category){
     ?>
      <p><a class="green-text" href="manage_category.php?id=<?php echo $category['id'];?>"><?php echo $category['name']; ?></a>
     <?php  
     }
     ?>
				</div>
