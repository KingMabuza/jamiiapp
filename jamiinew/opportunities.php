...
<head>
    ...
    <title>Opportunities | Jamii</title>
</head>
...
<body>
    ...
    <div class="container">
        <h3 class="black-text center">Opportunities</h3>
        <hr />
        <img src="static/opportunity_banner.jpg" class="center" width="100%" />
        <h4 class="center">Youth Funding</h4>
        <hr/>
        <ul>
            <li><h6><a href="https://www.nyda.gov.za/" class="green-text">NYDA</a></h6></li>
            <li><h6><a href="https://www.idc.co.za/gro-e-youth-scheme/" class="green-text">Gro-E Youth Scheme(IDC)</a></h6></li>
            <li><h6><a href="https://www.nefcorp.co.za" class="green-text">Nefcorp</a></h6></li>
        </ul>
        <h4 class="center">Women Funding</h4>
        <hr/>
        <ul>
            <li><h6><a href="https://www.gov.za/services/business-incentives/isivande-womens-fund" class="green-text">Isivande Womens Fund</a></h6></li>
        </ul>
